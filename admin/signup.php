      ...
      <div class="container">
            ...
            Lastname:<input name="lastname" type="text" pattern="[A-Za-z]{1,32}" id="lastname" class="form-control" placeholder="Lastname" required autofocus>
              ...
              Email:<input name="email" type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" id="email" class="form-control" placeholder="Email address" required autofocus>
                ...
                <tr><td>
              Contact:<input name="contact" type="text" data-mask="0000000000" pattern="[6-9]{1}[0-9]{9}" title="Enter valid number"  id="contact" class="form-control" placeholder="Phone No" required autofocus>
              </td>
                <td>
            ...
            <tr><td>
              Pincode:<input name="pincode" type="text" data-mask="000000" pattern="[4-7]{1}[0-9]{5}" id="pincode" class="form-control" placeholder="Enter pincode" required autofocus>
              </td></tr>
