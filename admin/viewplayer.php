...
<div class="content pb-0">
   <div class="orders">
    ...
    while($row=mysqli_fetch_array($result))
    {
     ...
     <td> 
     <?php
      echo "<span class='badge badge-edit'><a href='editplayer.php?p_id=".$row['p_id']."'>Edit</a></span>&nbsp;";
      echo "<span class='badge badge-delete'><a href='?type=delete&p_id=".$row['p_id']."'>Delete</a></span>";
     ?> </td>
