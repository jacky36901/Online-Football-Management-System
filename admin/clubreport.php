...
$arr=explode(',', $_GET['c_id']);
$cid=$arr[0]; 

$name="";
$qry="select c_name from tbl_club where c_id='$cid'";
...
else
{
      ...
      $selectquery="select * from tbl_player where c_id=$cid";
      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="card">
            <div id='printMe'>
            <div class="card-body">
               <h4 class="box-title">&nbsp&nbsp Player Details:<b> <?php echo $name ?></b>
               </h4>
