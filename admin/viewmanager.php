   ...
   <div class="orders">
    ...
    while($row=mysqli_fetch_array($result))
    {
     ...
     <td><?php echo $row['m_id']." "; ?></td> 
      ...
      <td> 
      <?php
      echo "<span class='badge badge-edit'><a href='editmanager.php?m_id=".$row['m_id']."'>Edit</a></span>&nbsp;";
     echo "<span class='badge badge-delete'><a href='?type=delete&m_id=".$row['m_id']."'>Delete</a></span>";
     ?>
   </td>
