...
else
{
      ...
      $selectquery = "select tbl_player.*,tbl_club.c_id,tbl_club.c_name,tbl_manager.m_id from tbl_player,tbl_club,tbl_manager where tbl_player.c_id=tbl_club.c_id and tbl_club.m_id=tbl_manager.m_id and tbl_manager.m_id=$r" ;
