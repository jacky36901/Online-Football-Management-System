...
if(isset($_GET['p_id']) && $_GET['p_id']!=''){
 $p_id=$_GET['p_id'];
  ...
  $res=mysqli_query($con,"select * from tbl_player where p_id='$p_id'");
...
//$password=get_safe_value($con,$_POST['password']);
 ...
 if(isset($_GET['p_id']) && $_GET['p_id']!=''){
 $sql = "update tbl_player set firstname='$firstname',lastname='$lastname',contact='$contact',dob='$dob', housename='$housename',street='$street',state='$state',pincode='$pincode',position='$position' where p_id='$p_id' ";

if(performQuery($sql)){
                echo "<script>alert('Player details are updated')</script>";
            }else{
...
<body class="text-center">
      <div class="container">
            <form method="post" class="form-signin" name="signup" onsubmit="return check();">
              ...
              <h1 class="h3 mb-3 font-weight-normal">UPDATE <?php echo $p_id ?> </h1>

              <center><table style="margin-top: 30px;">
              Player id: <input type="number" name="m_id" required value="<?php echo $p_id?>" readonly>
            ...
            Lastname:<input name="lastname" type="text" pattern="[A-Za-z]{1,32}" id="lastname" class="form-control" placeholder="Lastname" required value="<?php echo $lastname;?>" >
              ...
              Contact:<input name="contact" type="text" pattern="[6-9]{1}[0-9]{9}" id="contact" class="form-control" placeholder="Phone No" required  value="<?php echo $contact;?>">
                ...
                <td style="width:300px;padding-left: 50px;">
              Date of birth:<input name="dob" type="date"  max="2004-01-01" id="dob" class="form-control" placeholder="Date of birth" required value="<?php echo $dob?>">
              </td></tr>
                <tr><td style="width:300px;">
